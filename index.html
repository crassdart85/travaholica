    ...
    <div class="container">
      <div class="section-title">
        <div>
          ...
          <p>Don’t show “No reviews”. If you’re early, add 2–3 real testimonials and expand later.</p>
        </div>
        <a class="btn btn-ghost" href="#" title="Link to Google/Tripadvisor reviews">View all reviews</a>
      </div>

      <div class="grid test-grid">
        <div class="quote">
          <div class="rating"><span class="stars">★★★★★</span> 5.0</div>
          <p>“Everything was seamless — the guide made the history come alive. 10/10.”</p>
          <div class="who">
            <div class="avatar"><img alt="Traveler avatar" src="https://i.pravatar.cc/80?img=12"></div>
            <div>
              <strong>Sarah M.</strong>
              <span>UK • Egypt Highlights</span>
            </div>
          </div>
        </div>
        ...
        <div class="quote">
          <div class="rating"><span class="stars">★★★★★</span> 5.0</div>
          <p>“The itinerary was perfect — not rushed, and the local spots were incredible.”</p>
          <div class="who">
            <div class="avatar"><img alt="Traveler avatar" src="https://i.pravatar.cc/80?img=47"></div>
            <div>
              <strong>Michael R.</strong>
              <span>USA • Cairo & Giza</span>
            </div>
          </div>
        </div>
        ...
        <div class="quote">
          ...
          <p>“We felt taken care of from start to finish. Communication was fast and clear.”</p>
          <div class="who">
            <div class="avatar"><img alt="Traveler avatar" src="https://i.pravatar.cc/80?img=7"></div>
            <div>
              <strong>Nina K.</strong>
              <span>Germany • Nepal Trip</span>
            </div>
          </div>
        </div>
      </div>
